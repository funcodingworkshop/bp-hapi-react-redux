...
class CourseAddComponent extends Component {
  static propTypes = {
    ...
    sectionsList: Type.array.isRequired,
    fetchSections: Type.func.isRequired
  }
    ...
    return (
      ...
      <div className="App-logo">
        ...
        <Grid item xs={12} md={6}>
          <Link to="/courses_new" className="no-text-decoration"><Button variant="outlined" color="primary">Список курсов</Button></Link>
        </Grid>
